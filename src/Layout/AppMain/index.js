...
const Maps = lazy(() => import('../../DemoPages/Maps'));
        ...
        <Fragment>
            ...
            <Suspense fallback={
                <div className="loader-container">
                    <div className="loader-container-inner">
                        <h6 className="mt-5">
                            Please wait while we load all the Maps examples
                            <small>Because this is a demonstration we load at once all the Maps examples. This wouldn't happen in a real live app!</small>
                        </h6>
                    </div>
                </div>
            }>
